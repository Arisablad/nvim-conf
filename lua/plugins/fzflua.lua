return {
  ...
  opts = {},
  keys = {
    {"<leader><leader>", function() require("fzf-lua").builtin() end, desc = "Fzf Lua Global"},

    {"<leader>ff", function() require("fzf-lua").files() end, desc = "[F]ind [Files] in Current Working Directory"},

    {"<leader>fg", function() require("fzf-lua").live_grep() end, desc = "[F]ind [G]repping current working directory"},
    ...
    {"<leader>fo", function() require("fzf-lua").oldfiles() end, desc = "[F]ind in [O]ld Recent Files"},
  },
